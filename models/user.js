...
const userSchema = new mongoose.Schema({
    ...
    biocolor: { type: String, default: '#FF0000' }, // Added chatcolor field
    statuscolor: { type: String, default: '#FF0000' }, // Added chatcolor field
    ...
    fcmToken:{type:String,default:'token'},
